...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // if both data and isSuccess are truthy values, the condition if (isSuccess) inside the useEffect Hook will evaluate to true, and the logic within that if block will execute.
  }, [data, isSuccess]);
